...
![image](https://github.com/hawyinng/newifi_car/blob/master/images/IMG_14.jpg) ![image](https://github.com/hawyinng/newifi_car/blob/master/images/IMG_4.jpg)   
...
# 安装程序说明
1./Arduino/sketch_jun12c/sketch_jun12c.ino 编译上传Arduino UNO R3开发板。  
2.WinSCP远程登录newifi路由器“192.168.0.1”，SCP协议连接。用户名“root”，密码“password”。  
...
5.SSH连接newifi路由器，“/”根目录下，输入"./c_openwrt_newifi &"命令，或者输入"./start_newifi.sh"命令，运行c_openwrt_newifi服务端。  
