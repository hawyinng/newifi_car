...
QT_MOC_LITERAL(1, 13, 7), // "setPlan"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 1) // "i"

    },
    "ListenThread\0setPlan\0\0i"
};
...
void ListenThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->setPlan((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
QT_INIT_METAOBJECT const QMetaObject ListenThread::staticMetaObject = { {
    QMetaObject::SuperData::link<PlanThread::staticMetaObject>(),
...
void *ListenThread::qt_metacast(const char *_clname)
{
    ...
    return PlanThread::qt_metacast(_clname);
}

int ListenThread::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = PlanThread::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    if (_c == QMetaObject::InvokeMetaMethod) {
        if (_id < 1)
